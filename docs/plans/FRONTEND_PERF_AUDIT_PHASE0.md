...
| P0-03 | Quote modal backdrop blur            | `get-quote-modal.tsx`                                    | Medium           | Low                      | Audit on open                            | pending |
...
| P0-11 | Tablet hero top gradient             | `globals.css` `.neetrino-canvas-wrap--tablet-hero`       | Low              | Medium                   | Tier B: solid color band                 | pending |
