...
export function Partners() {
  ...
  return (
    <section
      ...
      className="max-w-full min-w-0 bg-transparent pt-4 pb-2 lg:mt-0 lg:bg-[#151515] lg:px-0 lg:pb-5 lg:pt-0 lg:leading-none lg:[&_span]:m-0 lg:[&_span]:block lg:[&_span]:leading-none"
      style={{
        overflow: "hidden",
