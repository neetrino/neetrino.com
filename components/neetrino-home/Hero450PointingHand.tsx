...
import {
  ...
  HOME_450_HAND_ARC_PRESS_X_PX,
  HOME_450_HAND_ARC_PRESS_Y_PX,
...
export function Hero450PointingHand({
  ...
  const pointMotionStyle = {
    ...
    ["--home-450-hand-arc-x-press" as string]: `${HOME_450_HAND_ARC_PRESS_X_PX}px`,
    ["--home-450-hand-arc-y-press" as string]: `${HOME_450_HAND_ARC_PRESS_Y_PX}px`,
