...
export const MOBILE_NAV_DRAWER_CARD_CLASS =
  "pointer-events-auto mx-auto flex w-full max-w-lg min-h-0 max-h-[min(85dvh,calc(100dvh-5.5rem))] flex-col overflow-hidden rounded-[28px] border border-white/12 bg-[rgba(40,43,103,0.38)] shadow-[0_24px_60px_rgba(0,0,0,0.42)] backdrop-blur-xl backdrop-saturate-150" as const;
