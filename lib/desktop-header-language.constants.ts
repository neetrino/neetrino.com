...
/** Inner layout vs. pill — Figma 10:458–10:461 */
export const DESKTOP_HEADER_LANGUAGE_ICON_OFFSET_LEFT_PX = 7;
export const DESKTOP_HEADER_LANGUAGE_ICON_OFFSET_TOP_PX = 4;
export const DESKTOP_HEADER_LANGUAGE_ICON_PX = 40;
export const DESKTOP_HEADER_LANGUAGE_LABEL_LEFT_PX = 58;
export const DESKTOP_HEADER_LANGUAGE_GLOBE_PX = 24;
