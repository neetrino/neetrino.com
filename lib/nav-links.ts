...
export const PRIMARY_NAV_LINK_UNDERLINE_TRACK_CLASS = cn(
  ...
  "after:h-px after:max-w-full after:w-full after:translate-y-[2px] after:rounded-full after:origin-left after:scale-x-0",
  ...
  "after:transition-[transform,box-shadow] after:duration-[340ms] after:ease-[cubic-bezier(0.22,1,0.36,1)]",
