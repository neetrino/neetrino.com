import {
  SITE_FOOTER_MOBILE_SURFACE_DUO_BOTTOM_BLEED_CLASS,
  SITE_FOOTER_MOBILE_SURFACE_DUO_COPYRIGHT_CLASS,
  SITE_FOOTER_MOBILE_SURFACE_DUO_OUTER_STACK_CLASS,
  SITE_FOOTER_MOBILE_SURFACE_DUO_SOCIAL_ROW_CLASS,
} from "@/lib/site-footer-surface-duo-layout.constants";
 ...
 * - **Surface Duo portrait (~540×720):** column + bottom strip left-aligned (`surface-duo-portrait`).
...
export const SITE_FOOTER_MOBILE_OUTER_STACK_CLASS =
  `relative z-10 max-md:mx-auto max-md:max-w-[min(100%,22.75rem)] max-md:px-4 max-md:pb-10 max-md:pt-[2.875rem] max-md:sm:px-5 md:mx-0 md:flex md:w-full md:min-w-0 md:max-w-none md:flex-col md:px-0 md:pb-0 md:pt-0 ${SITE_FOOTER_MOBILE_SURFACE_DUO_OUTER_STACK_CLASS}` as const;
...
export const SITE_FOOTER_MOBILE_BOTTOM_BLEED_CLASS =
  `relative z-10 w-full min-w-0 flex flex-col items-center px-4 pb-10 sm:px-5 md:px-8 max-md:block max-md:items-stretch max-md:px-0 max-md:pb-0 ${SITE_FOOTER_MOBILE_SURFACE_DUO_BOTTOM_BLEED_CLASS}` as const;
...
export const SITE_FOOTER_MOBILE_SOCIAL_ROW_CLASS =
  `mt-8 flex w-full min-w-0 flex-wrap items-center justify-center gap-4 max-md:px-4 md:px-0 ${SITE_FOOTER_MOBILE_SURFACE_DUO_SOCIAL_ROW_CLASS}` as const;

/** Copyright strip — centered under the icon row; left-aligned on Surface Duo portrait. */
export const SITE_FOOTER_MOBILE_COPYRIGHT_CLASS =
  `text-center text-xs font-normal leading-4 text-[#dcd5d5] ${SITE_FOOTER_MOBILE_SURFACE_DUO_COPYRIGHT_CLASS}` as const;
